...
public class StudentTest {
    ...
    public void getName_RUSSIAN() {
        student.setAttr("Name", "Студент");
        assertEquals("Студент", student.getName());
    }

    @Test
    public void getGroup() {
        student.setAttr("Group", "КН-203");
    ...
    public void getGroup_LESSNUMBEROFDECIMALS() {
        assertEquals("Введите группу по шаблону КН-203",
                student.setAttr("Group", "КН-00"));
    }

    @Test
    public void getGroup_BIGGERNUMBEROFDECIMALS() {
        assertEquals("Введите группу по шаблону КН-203",
                student.setAttr("Group", "КН-2032"));
    }
    ...
    public void getSubgroup_0() {
        assertEquals("введите 1 или 2", student.setAttr("Subgroup", "0"));
    }

    @Test
    public void getSubgroup_3() {
        assertEquals("введите 1 или 2", student.setAttr("Subgroup", "3"));
    }

    @Test
    public void getSubgroup_NOTANUMBER() {
        assertEquals("введите 1 или 2", student.setAttr("Subgroup", "h"));
    }

    @Test
    public void testToString() {
        student.setAttr("Name", "Наташа");
        student.setAttr("Group", "КН-203");
        student.setAttr("Subgroup", "1");
